<template>
  <div class="h-screen w-screen overflow-hidden p-10 flex justify-center items-center">
    ...
    />
    <thirdElementCard
      class="parallax absolute drop-shadow-2xl right-52 lg:block hidden top-24 z-[-1]"
      v-motion-slide-bottom
    />
    <fourthElementCard
      class="parallax absolute drop-shadow-2xl left-48 lg:block hidden bottom-10 z-[-1]"
      v-motion-slide-left
    />
  </div>
</template>
